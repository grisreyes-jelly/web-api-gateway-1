...
RUN go get github.com/grisreyes-jelly/web-api-gateway-final/tree/master/server@latest
RUN go install github.com/grisreyes-jelly/web-api-gateway-final/tree/master/server@latest
